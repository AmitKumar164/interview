...
from .views import SignupView, SendOtpView, VerifyOtpView, FetchUserView, SendEventUserMail, RegisterInterviewer, AddCompanyView, RegisterHR
app_name = 'user_data'
urlpatterns = [
    ...
    path("v1/companies-hr/", RegisterHR.as_view(), name="companies-hr"),
]
